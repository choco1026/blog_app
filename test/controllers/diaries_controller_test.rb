...
class DiariesControllerTest < ActionController::TestCase
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post :create, diary: { body: @diary.body, comment_id: @diary.comment_id, status: @diary.status, title: @diary.title }
    end
  ...
  test "should update diary" do
    patch :update, id: @diary, diary: { body: @diary.body, comment_id: @diary.comment_id, status: @diary.status, title: @diary.title }
    assert_redirected_to diary_path(assigns(:diary))
  end
